export default async function handler(req, res) {
  ...
  const nftData =
    "0x23d96e8df4e62ffc49439f416b0684e3fd5b9d7cccddf73aadd107b44f5eaffa"; // returned from /api/loopring
  const url = `https://api3.loopring.io/api/v3/nft/info/nfts?nftDatas=${nftData}`;
